...
#
# 012.With the data generated in "011-data format conversion.R", then we calibrate  
#     the simulated temperatures with observed temperatures
# 013.Identify the heatwaves based on the calibrated data of each model for the scenarios
...
#  -Data generated from "011-data format conversion.R"
#     1. grid_tmax_obs.csv; 
