...
#
# 011.Before calculation, we first reorganize the observed and simulated  
...
#  -shp file, providing the longitudes and latitudes at a 0.5 degree resolution
#     for all provinces in China
