...
###########################################################################################################
# 01. CALIBRATE THE SIMULATED TEMPERATURES, IDENTIFY HEATWAVES FOR EACH MODEL AND CALCULATE THE HEATWAVE 
#     DAYS FOR FACTUAL AND COUNTERFACTUAL SCENARIOS AND THOSE INDUCED BY ANTHROPOGENIC CLIMATE CHANGE.
#
# 014.With the results generated in "012-013-calibration and identification for each model.R", we calculated  
#     heatwave days for 1) the factual scenario, 2) counterfactual scenario and 3) those induced by anthropogenic
#     climate change.
#
# LOAD RELEVANT DATA AND FILE
#  -Results generated from "012-013-calibration and identification for each model.R"
