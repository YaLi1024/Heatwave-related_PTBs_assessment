...
#  -annual birth rates.xlsx,providing provincial birth rates in China.
#  -prevalence of preterm birth.csv, estimated by findings of previous studies and providing
#     the provincial PTB rates in China during 2010-2020.
#  -monthly birth proportions.xlsx, providing the proportion of living birth in each 
...
#  -grid_with_hwpre1w_sum_2.csv, providing the information of heatwave exposures of mothers who 
#     delivered prematurely in each day, which was determined by heatwave days identified basd on
...
#     that the grid belongs to.
  nation_birth_rate0 <- read_excel("annual birth rates.xlsx")
...
## 4) Calculate the baseline PTB birth number in warm seasons during 2010-2020 for China ##############
  ...
  nation_preterm_rate <- read_csv("prevalence of preterm birth.csv")
 ...
 # estimate the PTB birth number in warm seasons per year at the grid level
  birth_proportion_by_month <- read_excel("monthly birth proportions.xlsx")
...
# grid_with_hwpre1w_sum_2.csv provides the information of heatwave exposures of mothers who 
...
#     team, and based on the Monte Carlo simulation to obtain the samples of coefficients
  ...
  grid_with_hwpre1w_sum.2 <- read_csv("grid_with_hwpre1w_sum_2.csv")
