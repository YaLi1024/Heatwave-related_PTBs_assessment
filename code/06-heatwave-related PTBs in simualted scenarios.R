...
##########################################################################################
## 06 CALCULATE THE HEATWAVE-RELATED PTBS IN THE FACTUAL AND COUNTERFACUTAL SCENARIOS AND
##    THOSED CAUSED BY ANTHROPOGENIC CLIMATE CHANGE
##########################################################################################
# LOAD RELEVANT DATA
#   - grid_PTB_month.csv calculated and saved in "05-Heatwave-related PTBs in the actual climate.R"
#   - Data obtained from "032-033-calibration and identification for each model.R"
...
#  The process can be conducted by Excel directly based on grid_aPTB_hist.csv and grid_aPTB_nat.csv,
#     so we did not provide the code.
#  Figure 2 can be drawn in the same way as shown in "04-map 42year heatwave days.R", the code in 
#     which can be referred to draw Figure 2.  
